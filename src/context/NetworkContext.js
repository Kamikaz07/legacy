...
const RPC_ENDPOINTS = {
  [NETWORKS.MAINNET]: process.env.REACT_APP_MAINNET_RPC || 'https://solana-mainnet.rpc.extrnode.com',
  [NETWORKS.TESTNET]: process.env.REACT_APP_TESTNET_RPC || clusterApiUrl(NETWORKS.TESTNET),
  [NETWORKS.DEVNET]: process.env.REACT_APP_DEVNET_RPC || clusterApiUrl(NETWORKS.DEVNET),
};
