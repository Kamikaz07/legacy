...
import {
  ...
  FormControl,
  Paper,
  // Alert is imported but not used
  // Alert,
} from "@mui/material";
...
const ChaosPaper = styled(Paper)(({ theme }) => ({
  ...
  overflow: "hidden",
  backgroundImage:
    "radial-gradient(rgba(146, 230, 67, 0.03) 1px, transparent 1px)",
...
const CoinCreator = () => {
  ...
  const onDrop = useCallback((acceptedFiles) => {
    ...
    if (file) {
      ...
      img.onload = () => {
        if (
          img.width > MAX_IMAGE_DIMENSIONS ||
          img.height > MAX_IMAGE_DIMENSIONS
        ) {
          setErrorMessage(
            `Image exceeds maximum dimensions of ${MAX_IMAGE_DIMENSIONS}x${MAX_IMAGE_DIMENSIONS} pixels.`,
          );
          setImageFile(null);
        } else {
          setImageFile(file);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (socialLinks.website)
        filteredSocialLinks.website = socialLinks.website;
      if (socialLinks.twitter)
        filteredSocialLinks.twitter = socialLinks.twitter;
      ...
      if (response.status === 200) {
        ...
        if (userBalance < feeInLamports + 5000) {
          // 5000 lamports para taxa de rede
          throw new Error(
            `Insufficient balance. You need at least ${response.data.fee} SOL to create this token.`,
          );
        }
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <PersonIcon sx={{ color: "#92E643", mr: 1 }} />
                    ),
                  }}
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  ...
                  InputProps={{
                    startAdornment: (
                      <AbcIcon sx={{ color: "#92E643", mr: 1 }} />
                    ),
                  }}
                  error={symbol.length > MAX_SYMBOL_LENGTH}
                  helperText={
                    symbol.length > MAX_SYMBOL_LENGTH
                      ? `Maximum ${MAX_SYMBOL_LENGTH} characters`
                      : ""
                  }
                  sx={{
                    "& .MuiOutlinedInput-root": {
      ...
      case 1:
        return (
          <>
            ...
            <Typography variant="caption" color="textSecondary">
              The transfer tax is charged on each token transaction. 100 basis
              points = 1%.
            </Typography>
          </>
        );
        ...
        return (
          <>
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <TwitterIcon sx={{ color: "#92E643", mr: 1 }} />
                ),
              }}
              sx={{
                "& .MuiOutlinedInput-root": {
            ...
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <LanguageIcon sx={{ color: "#92E643", mr: 1 }} />
                ),
              }}
              sx={{
                "& .MuiOutlinedInput-root": {
            ...
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <TelegramIcon sx={{ color: "#92E643", mr: 1 }} />
                ),
              }}
              sx={{
                "& .MuiOutlinedInput-root": {
            ...
            <Grid item xs={12} sm={4}>
              <Tooltip title="Prevents the creation of new tokens after launch">
                <Card sx={{ background: "#020301", borderRadius: "8px" }}>
                  <CardContent>
                    <Typography variant="h6" sx={{ color: "#92E643" }}>
                      Revoke Mint Authority
                    </Typography>
                    <Typography variant="body2">
                      Revoking mint authority prevents more tokens from being
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(e) =>
                            setRevokeMintAuthority(e.target.checked)
                          }
                          sx={{
                            color: "#92E643",
                            "&.Mui-checked": { color: "#92E643" },
                          }}
                        />
                      }
                      label="Enable"
              ...
              <Tooltip title="Prevents token accounts from being frozen">
                <Card sx={{ background: "#020301", borderRadius: "8px" }}>
                  <CardContent>
                    ...
                    <Typography variant="body2">
                      Revoking freeze authority prevents token accounts from
                      being frozen.
                    </Typography>
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(e) =>
                            setRevokeFreezeAuthority(e.target.checked)
                          }
                          sx={{
                            color: "#92E643",
                            "&.Mui-checked": { color: "#92E643" },
              ...
              <Tooltip title="Prevents changes to token metadata">
                <Card sx={{ background: "#020301", borderRadius: "8px" }}>
                  <CardContent>
                    ...
                    <Typography variant="body2">
                      Revoking update authority prevents changes to token
                      metadata.
                    </Typography>
                    <FormControlLabel
                      control={
                        <Checkbox
                          ...
                          onChange={(e) =>
                            setRevokeUpdateAuthority(e.target.checked)
                          }
                          sx={{
                            color: "#92E643",
                            "&.Mui-checked": { color: "#92E643" },
              ...
              <Grid item xs={12} sm={6}>
                ...
                >
                  <CardContent>
                    ...
                    <Typography>
                      <strong>Supply:</strong> {supply.toLocaleString()}
                    </Typography>
                    <Typography>
                      <strong>Network:</strong> {network}
                    </Typography>
                    <Typography>
                      <strong>Tax:</strong> {tax / 100}%
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <Card sx={{ backgroundColor: "rgba(10, 10, 10, 0.7)" }}>
                  <CardContent>
                    ...
                    <Typography>
                      <strong>Mint Authority Revoked:</strong>{" "}
                      {revokeMintAuthority ? "Yes" : "No"}
                    </Typography>
                    <Typography>
                      <strong>Freeze Authority Revoked:</strong>{" "}
                      {revokeFreezeAuthority ? "Yes" : "No"}
                    </Typography>
                    <Typography>
                      <strong>Update Authority Revoked:</strong>{" "}
                      {revokeUpdateAuthority ? "Yes" : "No"}
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
              ...
              <Grid item xs={12} sm={6}>
                <Card sx={{ backgroundColor: "rgba(10, 10, 10, 0.7)" }}>
                  <CardContent>
                    ...
                    <Typography>
                      <strong>Creation Fee:</strong> {tokenFee || "Loading..."}{" "}
                      SOL
                    </Typography>
                    <Typography variant="caption" color="textSecondary">
                      This fee will be automatically deducted from your wallet
              ...
              <Grid item xs={12} sm={6}>
                <Card sx={{ backgroundColor: "rgba(10, 10, 10, 0.7)" }}>
                  <CardContent>
                    ...
                    <Typography>
                      <strong>Website:</strong> {socialLinks.website || "None"}
                    </Typography>
                    <Typography>
                      <strong>Twitter:</strong> {socialLinks.twitter || "None"}
                    </Typography>
                    <Typography>
                      <strong>Telegram:</strong>{" "}
                      {socialLinks.telegram || "None"}
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
  ...
  return (
    <ChaosPaper>
      <Box>
        <Typography variant="h5" sx={{ color: "#92E643" }}>
          Create a new token
        </Typography>
        <Stepper
